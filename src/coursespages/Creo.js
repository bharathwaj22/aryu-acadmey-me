...
import Coursesiamge from "../assests/images/courses-about.webp";
...
import ogimg from "../assests/images/metaogImg/creo.webp";

//tools
import creo from "../assests/images/tools/creo.svg";
...
function Creo() {
  useEffect(() => {
    // Set page title
    document.title = "Creo Training in Chennai";
    ...
    setMetaTag(
      "description",
      "Learn 3D modeling, CAD tools, and assembly techniques in our PTC Creo course in Chennai at Aryu Academy. Start your design career with expert training!"
    );
    setMetaTag("keywords", "Creo Training in Chennai, Creo Course in Chennai");

    // Set Open Graph meta tags
    setMetaTag("og:title", "Creo Training in Chennai", true);
    setMetaTag(
      "og:description",
      "Learn 3D modeling, CAD tools, and assembly techniques in our PTC Creo course in Chennai at Aryu Academy. Start your design career with expert training!",
      true
    ...
    setMetaTag("twitter:title", "Creo Training in Chennai", true);
    setMetaTag(
      "twitter:description",
      "Learn 3D modeling, CAD tools, and assembly techniques in our PTC Creo course in Chennai at Aryu Academy. Start your design career with expert training!",
      true
      ...
      <section className="">
        ...
        <section className="p-4">
          <div className="courses-container ">
            <div className="courses-title mt-3">
              ...
              <div className="pt-2">
                <h1 className="mb-0 courses-texted">
                  <span className="live-projects-text">Creo Training</span>
                </h1>
                <h1 className="mb-0 courses-texted">
                  <span className="live-projects-text">in Chennai Coming Soon</span>
                </h1>
              </div>
              <hr className="border-white w-75"></hr>
              <div className="courses-description pt-3">
                Get Creo Training in Chennai at Aryu Academy for your next-level
                career!
              </div>
              <div>
            ...
            <Coursesform type={"creo"}></Coursesform>
          </div>
          ...
          <div className="tool-used ">
            <div className="d-flex justify-content-between flex-wrap-reverse ">
              <div className="about-training">
                ...
                <div className="courses-trainig-details mt-5">
                  Our Creo training program offers an in-depth introduction to
                  parametric design and feature-based modeling, helping you
                  master the fundamentals of 3D modeling. You will learn to
                  create and edit 2D and 3D sketches, design parts using tools
                  like extrude, revolve, sweep, and blend, and efficiently
                  manage views. The course covers key topics such as engineering
                  features (holes, shells, rounds, chamfers) and editing
                  features like mirror and pattern to enhance your designs.
                </div>
                <div className="courses-trainig-details mt-5">
                  In assembly modeling, you'll gain expertise in applying
                  constraints, conducting interference checks, and creating
                  exploded views. You will also learn drafting techniques to
                  produce professional technical drawings, add dimensions, and
                  use GD&T. By the end of this course, you'll have the practical
                  skills to design, analyze, and document projects using Creo,
                  preparing you for success in the CAD and engineering industry.
                </div>
          ...
          <div className=" ">
            <div className="tool-used">
              ...
              <div className="d-flex  flex-wrap  ">
                <img src={creo} alt="Explore in-demand courses at Aryu Academy, offering practical Creo skills for the digital age!" className="tool-used-image" />
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Overview of Creo</li>
                          <li>
                            Introduction to Parametric Design and Feature-Based
                            Modeling
                          </li>
                          <li>Understanding File Types in Creo</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Exploring Sketcher Tools</li>
                          <li>Creating 2D Drawings in Creo</li>
                          <li>Working with 3D Drawings in Creo</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Getting Started with Part Modeling in Creo</li>
                          <li>
                            Understanding Base Features: Extrude, Revolve,
                            Sweep, Blend, Swept Blend
                          </li>
                          <li>Navigating the View Manager</li>
                          <li>
                            Engineering Features: Hole, Shell, Round, and
                            Chamfer
                          </li>
                          <li>Editing Features: Mirror and Pattern</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript ">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Introduction to Assembly Modeling</li>
                          <li>Applying Assembly Constraints</li>
                          <li>Performing Interference and Clearance Checks</li>
                          <li>Creating Exploded Views for Assemblies </li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3 ">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Overview of Drafting in Creo</li>
                          <li>Creating Drawing Views and Templates</li>
                          <li>Inserting Formats and Templates</li>
                          <li>Using Show & Erase Tools for Drawings</li>
                          <li>Creating Dimensions and Symbols</li>
                          <li>Bill of Materials (BOM) Creation</li>
                          <li>
                            Understanding GD&T (Geometric Dimensioning and
                            Tolerancing) in Drafting
                          </li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Introduction to Sheet Metal Design in Creo</li>
                          <li>Understanding Sheet Metal Parameters</li>
                          <li>
                            Creating Sheet Metal Parts: Bend, Unbend, Flange
                          </li>
                          <li>
                            Sheet Metal Features: Wall, Tab, and Bend Radius
                          </li>
                          <li>Using the Flat Pattern Tool</li>
                          <li>Converting a Solid Model to Sheet Metal</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
          ...
          <div className="d-flex flex-wrap-reverse justify-content-around mt-2 mt-md-5">
            <div className="industry-certificate">
              ...
              <div className="courses-trainig-details mt-2 mt-md-5">
                At Aryu Academy, our Creo certification is trusted by leading
              ...
              <div className="benefits-courses mt-0 mt-md-5 pt-2">
                Benefits of Creo Certification
              </div>
              <div className="courses-trainig-details mt-0 mt-md-5">
                <ul>
                  <li>
                    Prove your expertise by mastering Creo and showcasing your
                    skills.
                  </li>
                  <li>
                  ...
                  <li>
                    Gain credibility as a go-to Creo expert who drives results.
                  </li>
                </ul>
              </div>
            </div>
            <div>
              <img src={Certification} alt="Get an Industry-Recognized Certification in Creo from ARYU Academy – 6-Month Course Completion." className="student-certificate" />
            </div>
          </div>
        </section>
          ...
          <div className="d-flex flex-wrap justify-content-around   pt-5">
            ...
            <div className="industry-certificate p-3 p-md-0 ">
              ...
              <div className="courses-trainig-benefits-para mt-5">
                Aryu Academy’s Creo Training in Chennai. Led by
              ...
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingOne">
                    ...
                    >
                      What is Creo, and why should I learn it?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Creo is a powerful 3D CAD software used for product
                      design, engineering, and manufacturing. Learning Creo can
                      open up job opportunities in industries like automotive,
                      aerospace, consumer products, and more. It is a valuable
                      skill for engineers, designers, and CAD professionals.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingTwo">
                    ...
                    >
                      What topics are covered in a Creo course?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      A typical Creo course covers:
                      <ul>
                        <li>Introduction to Creo interface and tools</li>
                        <li>3D modeling and part creation</li>
                        <li>Assembly design and management</li>
                        <li>Sheet metal design</li>
                        <li>Parametric design</li>
                        <li>
                          Advanced features like simulation, rendering, and
                          analysis
                        </li>
                      </ul>
                    </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingThree">
                    ...
                    >
                      Can Creo courses help me get a job?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, completing a Creo course can significantly improve
                      your employability in industries that require 3D CAD
                      design skills. Many job roles such as CAD designer,
                      mechanical engineer, and product designer require
                      proficiency in software like Creo.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfour">
                    ...
                    >
                      What skills can I gain from taking a Creo course?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      By taking a Creo course, you can gain skills in 3D
                      modeling, parametric design, assembly management, CAD data
                      organization, simulation, and product lifecycle
                      management. These skills are highly sought after in many
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfive">
                    ...
                    >
                      Are there any advanced Creo courses available?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, once you’ve completed basic training, you can enroll
                      in advanced Creo courses that focus on specialized topics
                      like simulation, advanced assembly management, and
                      automation. These courses provide in-depth knowledge for
                      users who wish to specialize in specific areas of product
                      design.
                    </div>
                  </div>
                </div>
