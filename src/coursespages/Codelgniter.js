...
import Coursesimage from "../assests/images/courses-banner-Img/CodeIgniter-course-in-Chennai.png";
...
import ogimg from "../assests/images/metaogImg/codeIgniter.webp";

//tools
import CODINGNET from "../assests/images/tools/CODINGNET.svg";
import phpstrom from "../assests/images/tools/phpstrom.svg";
import phpunit from "../assests/images/tools/phpunit.svg";
import Postman from "../assests/images/tools/Postman.svg";
import docker from "../assests/images/tools/docker.svg";
// import Bitbucket from "../assests/images/tools/Bitbucket.svg";
import Git from "../assests/images/tools/Git.svg";
import { useNavigate } from "react-router-dom";
import Contact from "../components/Contact.js";
function Codelegniter() {
  useEffect(() => {
    // Set page title
    document.title = "CodeIgniter Course in Chennai";
    ...
    setMetaTag(
      "description",
      "Level up your web dev skills with CodeIgniter courses in Chennai. Build secure, dynamic apps. Explore training at Aryu Academy. Enroll now and get started!"
    );
    setMetaTag(
      "keywords",
      "CodeIgniter Course in Chennai, CodeIgniter training in Chennai"
    );

    // Set Open Graph meta tags
    setMetaTag("og:title", "CodeIgniter Course in Chennai", true);
    setMetaTag(
      "og:description",
      "Level up your web dev skills with CodeIgniter courses in Chennai. Build secure, dynamic apps. Explore training at Aryu Academy. Enroll now and get started!",
      true
    ...
    setMetaTag("twitter:title", "CodeIgniter Course in Chennai", true);
    setMetaTag(
      "twitter:description",
      "Level up your web dev skills with CodeIgniter courses in Chennai. Build secure, dynamic apps. Explore training at Aryu Academy. Enroll now and get started!",
      true
      ...
      <section className="">
        ...
        <section className="p-4">
          <div className="courses-container ">
            <div className="courses-title mt-3">
              ...
              <div className="pt-2">
                <h1 className="mb-0 courses-texted">
                  <span className="live-projects-text">CodeIgniter Course</span>
                </h1>
                <h1 className="mb-0 courses-texted">
              ...
              <div className="courses-description pt-3">
                Get a CodeIgniter Course in Chennai at Aryu academy for your
                next-level career!
              </div>
              <div>
                <div className="d-flex  align-items-center  gap-3 mt-5 ">
                  ...
                  <div>
                    ...
                    Have any Questions? Call us                    </div>
                    <a href="tel:+919994715106" className="courses-number">
                      +91 99947 15106
                    </a>{" "}
                  </div>
                </div>
            ...
            <Coursesform type={"codelgniter"}></Coursesform>
          </div>
            ...
            <div className="d-flex justify-content-between flex-wrap-reverse ">
              <div className="about-training">
                ...
                <div className="courses-trainig-details mt-4">
                  Our CodeIgniter training program equips you with the skills to
                  develop dynamic, secure, and scalable web applications. You’ll
                  dive deep into the MVC architecture, learning how to
                  effectively use controllers, models, and views. The course
                  includes hands-on sessions on database integration with MySQL
                  or MongoDB, enabling you to create efficient data-driven
                  applications.
                </div>
                <div className="courses-trainig-details mt-4">
                  You’ll master essential features like session management,
                  authentication, file handling, and AJAX integration. Advanced
                  topics such as creating custom libraries, pagination, and
                  optimizing application performance are also covered. Security
                  is a key focus, with training on preventing threats like SQL
                  injection and XSS attacks.
                </div>
                <div className="courses-trainig-details mt-4">
                  Through real-world projects, you’ll gain practical experience
                  and confidence to deploy professional-grade web applications.
                  Whether you’re starting a career in web development or
                  upskilling, this course offers the tools you need to succeed
              ...
              <div className="about-training-image pt-0 pt-md-5 ">
                <img
                  ...
                  src={Coursesimage}
                  alt="CodeIgniter course at Aryu Academy in Chennai, teaching web application development with the CodeIgniter PHP framework."
                />
              </div>
            </div>
          </div>
          ...
          <div className=" ">
            <div className="tool-used">
              ...
              <div className="d-flex  flex-wrap  ">
                <img src={CODINGNET} alt="CodeIgniter toolkit tools used in Aryu Academy’s course for developing fast and secure PHP web applications." className="tool-used-image" />
                <img src={phpstrom} alt=" PHPStorm tools used in Aryu Academy’s CodeIgniter course for efficient PHP development and debugging." className="tool-used-image" />
                <img src={phpunit} alt="j PHPUnit tools used in Aryu Academy’s CodeIgniter course for unit testing and ensuring robust code quality." className="tool-used-image" />
                <img src={Postman} alt="Postman tool used in Aryu Academy’s CodeIgniter course for testing APIs and ensuring smooth communication." className="tool-used-image" />
                <img src={docker} alt="Docker tools used in Aryu Academy’s CodeIgniter course for containerizing applications and ensuring smooth deployment." className="tool-used-image" />
                {/* <img src={Bitbucket} alt="php" className="tool-used-image" /> */}
                <img src={Git} alt="GitHub tools used in Aryu Academy’s CodeIgniter course for version control and collaboration on code projects." className="tool-used-image" />
              </div>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Overview of CodeIgniter</li>
                          <li>Understanding MVC Architecture</li>
                          <li>Installing and Configuring CodeIgniter</li>
                          <li>Directory Structure and CodeIgniter Workflow</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    >
                      <Typography>
                        ...
                        <Typography component="span" className="text-drop mt-1">
                          PHP Fundamentals for CodeIgniter
                        </Typography>
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Controllers, Models, and Views</li>
                          <li>Creating Routes in CodeIgniter</li>
                          <li>Loading Libraries and Helpers</li>
                          <li>Working with Configurations and Constants</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          ...
                          <li>Querying Databases Using CodeIgniter Models</li>
                          <li>
                            Working with MySQL (SELECT, INSERT, UPDATE, DELETE)
                          </li>
                          <li>Introduction to MongoDB (Optional Module)</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Creating HTML Forms in CodeIgniter </li>
                          <li>GET vs POST Methods</li>
                          <li>Validating and Sanitizing User Input</li>
                          <li>Implementing Error Messages</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript ">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Managing Sessions in CodeIgniter</li>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>File Upload and Image Manipulation</li>
                          <li>Pagination for Large Data Sets</li>
                          <li>Email Sending and Notifications</li>
                          <li>Implementing AJAX with CodeIgniter</li>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Preventing SQL Injection with Query Builder</li>
                          <li>
                            Cross-Site Scripting (XSS) and Cross-Site Request
                            Forgery (CSRF) Protection
                          </li>
                          <li>Using Input Filters and Data Validation</li>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Using Built-In Libraries (Email, Form, Pagination)
                          </li>
                          <li>Creating Custom Libraries and Helpers</li>
                          <li>Extending CodeIgniter Core Classes</li>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    >
                      <Typography>
                        ...
                        <Typography component="span" className="text-drop mt-1">
                          Final Project and Career Opportunities
                        </Typography>
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Developing a Web Application with CodeIgniter and
                            MySQL/MongoDB{" "}
                          </li>
                          <li>Deploying the Application to a Server</li>
                          <li>Presenting Your Project for Review</li>
                          <li>
                            Career Paths and Freelancing Opportunities in
          ...
          <div className="d-flex flex-wrap-reverse justify-content-around mt-2 mt-md-5">
            <div className="industry-certificate">
              ...
              <div className="courses-trainig-details mt-2 mt-md-5">
                At Aryu Academy, our CodeIgniter certification is trusted by
              ...
              <div className="benefits-courses mt-0 mt-md-5 pt-2">
                Benefits of CodeIgniter Certification
              </div>
              <div className="courses-trainig-details mt-0 mt-md-5">
                <ul>
                  <li>
                    Prove your expertise by mastering CodeIgniter and showcasing
                    your skills.
                  </li>
                  <li>
                  ...
                  <li>
                    Gain credibility as a go-to CodeIgniter expert who drives
                    results.
                  </li>
                </ul>
              </div>
            ...
            <div>
              <img src={Certification} alt="Get an Industry-Recognized Certification in CodeIgniter from ARYU Academy – 6-Month Course Completion." className="student-certificate" />
            </div>
          </div>
        </section>
          ...
          <div className="d-flex flex-wrap justify-content-around   pt-5">
            ...
            <div className="industry-certificate p-3 p-md-0 ">
              ...
              <div className="courses-trainig-benefits-para mt-5">
                Aryu Academy’s CodeIgniter Training in Chennai. Led by
              ...
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingOne">
                    ...
                    >
                      What is CodeIgniter, and why should I learn it?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      for building dynamic and robust web applications. It is
                      popular for its speed, simplicity, and ease of use, making
                      it an excellent choice for developers who want to create
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingTwo">
                    ...
                    >
                      What topics will this CodeIgniter course cover?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      <ul>
                        ...
                        <li>Database interactions using Query Builder</li>
                        <li>Authentication and session management</li>
                        <li>Building RESTful APIs with CodeIgniter</li>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingThree">
                    ...
                    >
                      How secure is CodeIgniter for web development?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      CodeIgniter includes built-in features for security, like
                      input filtering, XSS prevention, and CSRF protection,
                      making it a secure framework for web development.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfour">
                    ...
                    >
                      What kind of learning materials are provided in the
                      course?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      You’ll get access to video tutorials, hands-on coding
                      exercises, project files, and downloadable study materials
                      for reference.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfive">
                    ...
                    >
                      Are there job opportunities for CodeIgniter developers?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, many companies still use CodeIgniter for their web
                      development projects, offering roles like PHP Developer,
                      Back-End Developer, and Web Application Developer.
                    </div>
                  </div>
                </div>
                {/* <div class="accordion-item">
