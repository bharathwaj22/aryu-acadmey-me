...
import Coursesiamge from "../assests/images/courses-banner-Img/Webflow-course-in-Chennai.png";
...
import ogimg from "../assests/images/metaogImg/webflow.webp";

//tools
import LOTTIEFILES from "../assests/images/tools/LOTTIEFILES.svg";
import zapier from "../assests/images/tools/zapier.svg";
import { useNavigate } from "react-router-dom";
function Word_flow() {
  useEffect(() => {
    // Set page title
    document.title = "Webflow Course In Chennai";
    ...
    setMetaTag(
      "description",
      "Learn modern web design with our Webflow course in Chennai. Build responsive, SEO-friendly websites with animations and e-commerce integration. Enroll now!"
    );
    setMetaTag(
      "keywords",
      "Webflow Course In Chennai, Webflow Training In Chennai"
    );

    // Set Open Graph meta tags
    setMetaTag("og:title", "Webflow Course In Chennai", true);
    setMetaTag(
      "og:description",
      "Learn modern web design with our Webflow course in Chennai. Build responsive, SEO-friendly websites with animations and e-commerce integration. Enroll now!",
      true
    ...
    setMetaTag("twitter:title", "Webflow Course In Chennai", true);
    setMetaTag(
      "twitter:description",
      "Learn modern web design with our Webflow course in Chennai. Build responsive, SEO-friendly websites with animations and e-commerce integration. Enroll now!",
      true
      ...
      <section className="">
        ...
        <section className="p-4">
          <div className="courses-container ">
            ...
            <Coursesform type={"web_flow"}></Coursesform>
          </div>
            ...
            <div className="d-flex justify-content-between flex-wrap-reverse ">
              <div className="about-training">
                ...
                <div className="courses-trainig-details mt-4">
                  Our Webflow training course unlocks the power of modern web
                  design and development, giving you the skills to create
                  stunning, responsive websites without needing to code. Dive
                  deep into Webflow’s design tools and master the art of
                  visually appealing layouts, dynamic content management, and
                  interactive animations.
                </div>
                <div className="courses-trainig-details mt-4">
                  Throughout the course, you will build real-world websites,
                  with a focus on SEO optimization, responsive design, and
                  e-commerce integration. Whether you're designing a portfolio,
                  a blog, or an online store, Webflow’s CMS will empower you to
                  create dynamic, easy-to-manage websites that impress clients
                  and users alike.
                </div>
                <div className="courses-trainig-details mt-4">
                  You’ll also explore advanced features like custom
                  interactions, animations, and the ability to launch and
                  maintain fully functional websites. By the end, you’ll have
                  the skills to craft powerful web experiences and expand your
                  career as a professional Webflow designer. Ready to bring your
                  web design vision to life? This course is your gateway!
                </div>
              </div>
          ...
          <div className=" ">
            <div className="tool-used">
              ...
              <div className="d-flex  flex-wrap  ">
                <img src={LOTTIEFILES} alt="LottieFiles tools used in Aryu Academy’s Webflow course for adding lightweight and interactive animations to websites." className="tool-used-image" />
                <img src={zapier} alt="Zapier tools used in Aryu Academy’s Webflow course for automating workflows and integrating Webflow with other apps." className="tool-used-image" />
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          ...
                          <li>Benefits of Using Webflow for Web Design</li>
                          <li>Overview of Webflow Interface and Dashboard</li>
                          <li>Setting Up a Webflow Project</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Understanding Containers, Sections, and Divs</li>
                          <li>Structuring a Web Page with Grids and Flexbox</li>
                          <li>Creating and Managing Pages</li>
                          <li>Responsive Design Basics in Webflow</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Working with Webflow's Designer Tool</li>
                          <li>Using Webflow's Style Panel for Customization</li>
                          <li>Adding and Customizing Typography</li>
                          <li>Implementing Colors, Gradients, and Images</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Introduction to Webflow Interactions</li>
                          <li>
                            Setting Up Page Scroll and Mouse-Triggered
                            Animations
                          </li>
                          <li>
                            Creating Hover Effects and Advanced Animations
                          </li>
                          <li>
                            Using Timelines and Triggers for Dynamic Content
                          </li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Introduction to the CMS in Webflow</li>
                          <li>Creating and Managing Collections</li>
                          <li>Using CMS Data in Web Pages</li>
                          <li>
                            Customizing Collection Pages for Dynamic Content
                          </li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                ...
                <div className="javascript">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Setting Up an E-commerce Store in Webflow</li>
                          <li>Adding Products and Managing Inventory</li>
                          <li>
                            Customizing Product Pages and Checkout Process
                          </li>
                          <li>
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          ...
                          <li>Setting Up SEO Settings in Webflow</li>
                          <li>Managing Meta Tags, Keywords, and Alt Text</li>
                          <li>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    >
                      <Typography>
                        ...
                        <Typography component="span" className="text-drop mt-1">
                          Advanced Webflow Customization
                        </Typography>
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Custom Code in Webflow: Adding HTML, CSS, and
                            JavaScript
                          </li>
                          <li>Integrating Third-Party APIs and Tools</li>
                          <li>Customizing Interactions with JavaScript</li>
                          <li>Using Webflow's Embed Code Feature</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Understanding Webflow Hosting and Domains</li>
                          <li>Setting Up Custom Domains</li>
                          <li>Publishing Websites with Webflow</li>
                          <li>
                            Understanding Webflow's Site Performance and
                            Analytics
                          </li>
                        </ul>
                      </Typography>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Building a Fully Functional Website with Webflow
                          </li>
                          <li>
                            Final Project: Designing a Personal or Business
                            Website
                          </li>
                          <li>Showcasing Your Work in a Portfolio</li>
                          <li>
                            Career Opportunities in Web Design and Freelancing
                            Tips
                          </li>
                        </ul>
                      </Typography>
          ...
          <div className="d-flex flex-wrap-reverse justify-content-around mt-2 mt-md-5">
            <div className="industry-certificate">
              ...
              <div className="courses-trainig-details mt-2 mt-md-5">
                At Aryu Academy, our Webflow certification is trusted by leading
              ...
              <div className="benefits-courses mt-0 mt-md-5 pt-2">
                Benefits of Webflow Developer Certification
              </div>
              <div className="courses-trainig-details mt-0 mt-md-5">
                <ul>
                  <li>
                    Prove your expertise by mastering Webflow and showcasing
                    your skills.
                  </li>
                  <li>
                  ...
                  <li>
                    Gain credibility as a go-to Webflow expert who drives
                    results.
                  </li>
                </ul>
              </div>
            ...
            <div>
              <img src={Certification} alt="Get an Industry-Recognized Certification in Webflow from ARYU Academy – 6-Month Course Completion." className="student-certificate" />
            </div>
          </div>
        </section>
          ...
          <div className="d-flex flex-wrap justify-content-around   pt-5">
            ...
            <div className="industry-certificate p-3 p-md-0 ">
              ...
              <div className="courses-trainig-benefits-para mt-5">
                Aryu Academy’s WebFlow Training in Chennai. Led by
              ...
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingOne">
                    ...
                    >
                      Can I export my Webflow website?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, you can export your Webflow website as HTML, CSS, and
                      JavaScript code. This is useful if you want to host the
                      site on a different server or use the code in another
                      project. However, exporting the site means losing
                      Webflow’s CMS and hosting features.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingTwo">
                    ...
                    >
                      Can I integrate third-party apps with Webflow?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, Webflow supports third-party integrations, including
                      tools for email marketing, analytics, and social media.
                      You can also use Webflow's built-in APIs to connect to
                      external services, such as Zapier, Mailchimp, and Google
                      Analytics.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingThree">
                    ...
                    >
                      Will I be able to build a responsive website with Webflow?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, Webflow is specifically designed to help you build
                      responsive websites. It allows you to create websites that
                      automatically adapt to different screen sizes, including
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      No, Webflow is designed to be user-friendly for those
                      without coding experience. You can design and launch
                      websites using the visual interface. However,
                      understanding HTML, CSS, and JavaScript can help you take
                      full advantage of Webflow’s customization features.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      Webflow is more design-focused and offers a visual
                      approach to web design, while WordPress is more content
                      management-focused and often requires plugins for advanced
                      design features. Webflow gives you more control over the
                      layout and design, while WordPress offers more flexibility
