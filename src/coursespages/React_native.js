...
import Coursesimage from "../assests/images/courses-banner-Img/React-Native-course-in-Chennai.png";
...
import ogimg from "../assests/images/metaogImg/reactNative.webp";

//tools
import VisualStudioCode from "../assests/images/tools/VisualStudioCode.svg";
import Xcode from "../assests/images/tools/Xcode.svg";
import Flipper from "../assests/images/tools/flipper.svg";
import AndroidStudio from "../assests/images/tools/AndroidStudio.svg";
import { useNavigate } from "react-router-dom";
function React_native() {
  useEffect(() => {
    // Set page title
    document.title = "React Native Training in Chennai";
    ...
    setMetaTag(
      "description",
      "React Native Training in Chennai at Aryu Academy Ready to build mobile apps? Master Android and iOS development with real projects. Join our course today!"
    );
    setMetaTag(
      "keywords",
      "React Native Training in Chennai, React Native course in Chennai"
    );

    // Set Open Graph meta tags
    setMetaTag("og:title", "React Native Training in Chennai", true);
    setMetaTag(
      "og:description",
      "React Native Training in Chennai at Aryu Academy Ready to build mobile apps? Master Android and iOS development with real projects. Join our course today!",
      true
    ...
    setMetaTag("twitter:title", "React Native Training in Chennai", true);
    setMetaTag(
      "twitter:description",
      "React Native Training in Chennai at Aryu Academy Ready to build mobile apps? Master Android and iOS development with real projects. Join our course today!",
      true
    ...
    <>
      <section className="">
          ...
          <div className="courses-container ">
            <div className="courses-title mt-3">
              ...
              <div className="courses-description pt-3">
                Get a React course in Chennai at Aryu Academy for your
                next-level career!
              </div>
              <div>
            ...
            <Coursesform type={"react_native"}></Coursesform>
          </div>
            ...
            <div className="d-flex justify-content-between flex-wrap-reverse flex-xl-nowrap ">
              <div className="about-training">
                ...
                <div className="courses-trainig-details mt-4">
                  Master mobile app development with our comprehensive React
                  Native Course, designed for both beginners and professionals.
                  Learn to set up your development environment, understand React
                  Native’s architecture, and create your first functional app.
                  Explore core concepts like state, props, event handling, and
                  form creation to build interactive applications.
                </div>
                <div className="courses-trainig-details mt-4">
                  Dive deeper into advanced topics such as seamless navigation,
                  integrating APIs, and managing app state with Context API and
                  Redux. Gain hands-on experience with animations, device
                  features like camera and location, and file handling
                  techniques to enhance your app’s functionality and user
                  experience.
                </div>
                <div className="courses-trainig-details mt-4">
                  The course concludes with a real-world project where you’ll
                  design, build, and deploy a complete mobile app for Android
                  and iOS. This practical approach ensures you gain the skills
                  and confidence to create high-quality, production-ready
                  applications.
                </div>
              </div>
              <div className="about-training-image pt-0 pt-md-5 ">
                <img
                  ...
                  src={Coursesimage}
                  alt="React Native course at Aryu Academy in Chennai, teaching mobile app development for iOS and Android platforms."
                />
              </div>
            </div>
          </div>
          ...
          <div className=" ">
            <div className="tool-used">
              ...
              <div className="d-flex  flex-wrap  ">
                <img
                  src={AndroidStudio}
                  alt="Android Studio tools used in Aryu Academy’s React Native course for building and testing mobile apps on Android."
                  className="tool-used-image"
                />
                <img src={Xcode} alt="Xcode tools used in Aryu Academy’s React Native course for building and testing mobile apps on iOS devices." className="tool-used-image" />
                <img src={Flipper} alt="Flipper tools used in Aryu Academy’s React Native course for debugging and inspecting mobile applications." className="tool-used-image" />
                <img
        ...
        <section className="d-flex flex-wrap justify-content-around mt-5">
          ...
          3 Months Course + 2 Months Internship          </div>
        </section>
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          ...
                          <li>Installing Node.js, npm, and Expo CLI</li>
                          <li>Installing IDEs (VSCode, Android Studio)</li>
                          <li>Setting up Emulator and Expo Go App</li>
                          <li>React Native Architecture</li>
                          <li>Overview of React Native Project Structure</li>
                          <li>Creating a Basic React Native App</li>
                          <li>Running on Emulator/Physical Device</li>
                          <li>
                            JSX and Basic Components: Text, View, and Image
                            Components
                          </li>
                          <li>
                            Styling in React Native: Inline vs. External Styles,
                            Flexbox for Layout
                          </li>
                        </ul>
                      </Typography>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    >
                      <Typography>
                        ...
                        <Typography component="span" className="text-drop mt-1">
                          Core Concepts and Component Interaction
                        </Typography>
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          ...
                          <li>
                            Handling Events: Adding Touch Events, Button and
                            Pressable Components
                          </li>
                          <li>
                            Lists and Rendering: FlatList, SectionList,
                            KeyExtractor, and List Performance
                          </li>
                          <li>
                            Forms in React Native: TextInput Component, Handling
                            Form Data
                          </li>
                          <li>
                            Hands-On Practice: Build a Simple Form with
                            Validation
                          </li>
                        </ul>
                      </Typography>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Introduction to React Navigation</li>
                          <li>Setting Up React Navigation</li>
                          <li>Stack Navigator Basics</li>
                          <li>Tab and Drawer Navigation</li>
                          <li>Passing Parameters between Screens</li>
                          <li>
                            Navigation Customization: Custom Headers, Deep
                            Linking in React Native
                          </li>
                          <li>
                            Hands-On Practice: Create a Multi-Screen Application
                          </li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Fetching Data from APIs: Making API Requests with
                            Fetch and Axios, Handling Responses and Errors
                          </li>
                          <li>
                            Managing State with Context API: Setting Up Context,
                            Using Context in Components
                          </li>
                          <li>
                            Redux Advanced: Actions, Reducers, Middleware, Async
                            Operations with Redux Thunk
                          </li>
                          <li>
                            Hands-On Practice: Create a Data-Driven Application
                          </li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    >
                      <Typography>
                        ...
                        <Typography component="span" className="text-drop mt-1">
                          Advanced Topics and Native Modules
                        </Typography>
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Animations: Basic Animations with Animated API,
                            Transition Effects
                          </li>
                          <li>
                            Accessing Device Features: React Native Libraries
                            (Camera, Location, Notifications), Permissions and
                            Integrations
                          </li>
                          <li>
                            File Handling and Storage: AsyncStorage, Secure
                            Storage, File Uploads and Downloads
                          </li>
                          <li>Advanced Animations and Device Features</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Preparing for Deployment: Generating Build for
                            Android and iOS, App Store and Play Store Guidelines
                          </li>
                          <li>
                            Final Project Development: Plan and Start Building
                            the Final Project
                          </li>
                        </ul>
                      </Typography>
          ...
          <div className="d-flex flex-wrap-reverse justify-content-around mt-2 mt-md-5">
            <div className="industry-certificate">
              ...
              <div className="courses-trainig-details mt-2 mt-md-5">
                At Aryu Academy, our React Native certification is trusted by
              ...
              <div className="benefits-courses mt-0 mt-md-5 pt-2">
                Benefits of React Native Certification
              </div>
              <div className="courses-trainig-details mt-0 mt-md-5">
                <ul>
                  <li>
                    Prove your expertise by mastering React Native and
                  ...
                  <li>
                    Gain credibility as a go-to React Native expert who drives
                    results.
                  </li>
                </ul>
              </div>
            ...
            <div>
              <img src={Certification} alt="Get an Industry-Recognized Certification in React Native from ARYU Academy – 6-Month Course Completion." className="student-certificate" />
            </div>
          </div>
        </section>
          ...
          <div className="d-flex flex-wrap justify-content-around   pt-5">
            ...
            <div className="industry-certificate p-3 p-md-0 ">
              ...
              <div className="courses-trainig-benefits-para mt-5">
                Aryu Academy’s React Native Training in Chennai. Led by
              ...
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      applications using React. It is popular because it allows
                      developers to create cross-platform apps for iOS and
                      Android with a single codebase, saving time and resources.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingTwo">
                    ...
                    >
                      Will I learn how to build apps for both iOS and Android?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, React Native enables you to create cross-platform
                      applications for iOS and Android, and this course covers
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingThree">
                    ...
                    >
                      What tools and software do I need to start with React
                      Native?
                    </button>
                  </h2>
                  <div
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfour">
                    ...
                    >
                      What are the job opportunities after completing a React
                      Native course?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      React Native developers are in high demand for roles like
                      Mobile App Developer, React Native Developer, and
                      Cross-Platform Developer, with competitive salaries.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      React is a library for building web apps, while React
                      Native is a framework for building mobile apps using React
                      principles.
                    </div>
                  </div>
                </div>
