...
import ogimg from "../assests/images/metaogImg/lara.webp";
...
function Laravel() {
  useEffect(() => {
    // Set page title
    document.title = "Laravel Course in Chennai";
    ...
    setMetaTag(
      "description",
      "Learn web development with our Laravel course in Chennai. Master PHP Frameworks, MVC, routing, Blade templating, MySQL, and build dynamic apps. Enroll today!"
    );
    setMetaTag(
      "keywords",
      "Laravel Course in Chennai, Laravel training in Chennai"
    );

    // Set Open Graph meta tags
    setMetaTag("og:title", "Laravel Course in Chennai", true);
    setMetaTag(
      "og:description",
      "Learn web development with our Laravel course in Chennai. Master PHP Frameworks, MVC, routing, Blade templating, MySQL, and build dynamic apps. Enroll today!",
      true
    ...
    setMetaTag("twitter:title", "Laravel Course in Chennai", true);
    setMetaTag(
      "twitter:description",
      "Learn web development with our Laravel course in Chennai. Master PHP Frameworks, MVC, routing, Blade templating, MySQL, and build dynamic apps. Enroll today!",
      true
      ...
      <section className="">
        ...
        <section className="p-4">
          <div className="courses-container ">
            ...
            <Coursesform type={"laravel"}></Coursesform>
          </div>
            ...
            <div className="d-flex justify-content-between flex-wrap-reverse  flex-xl-nowrap">
              <div className="about-training">
                ...
                <div className="courses-trainig-details mt-4">
                  Our Laravel course is designed to provide a comprehensive
                  understanding of web development using the PHP Laravel
                  framework. Over the course, you will learn key concepts such
                  as PHP syntax, control structures, and operators, while also
                  gaining hands-on experience with Laravel’s powerful MVC
                  architecture.
                </div>
                <div className="courses-trainig-details mt-4">
                  Starting with the basics of PHP, you will quickly dive into
                  Laravel’s features, including routing, controllers, and Blade
                  templating for frontend design. The curriculum covers database
                  integration with MySQL, migrations, and Eloquent ORM for
                  efficient database management. As you progress, you'll also
                  explore advanced topics like authentication, authorization,
                  file uploads, and notifications in Laravel.
                </div>
                <div className="courses-trainig-details mt-4">
                  By the end of the course, you will be equipped with the skills
                  to develop complex web applications and APIs. The final
                  project allows you to implement everything you’ve learned by
                  building a fully functional application, integrating
                  authentication, APIs, and best practices.
                </div>
              </div>
          ...
          <div className=" ">
            <div className="tool-used">
              ...
              <div className="d-flex  flex-wrap  ">
                <img src={LARAVEL} alt="Laravel tools used in Aryu Academy’s Laravel course for building scalable and secure web applications." className="Laravel tools used in Aryu Academy’s PHP & MySQL course for building scalable and secure web applications." />
                <img src={php} alt="PHP tools used in Aryu Academy’s PHP & MySQL course for creating dynamic web pages and server-side scripting." className="PHP tools used in Aryu Academy’s PHP & MySQL course for creating dynamic web pages and server-side scripting." />
                <img src={mysql} alt="MySQL tools used in Aryu Academy’s PHP & MySQL course for managing and querying databases in web applications." className="MySQL tools used in Aryu Academy’s PHP & MySQL course for managing and querying databases in web applications." />
              </div>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    >
                      <Typography>
                        ...
                        <Typography component="span" className="text-drop mt-1">
                          Introduction to PHP and Laravel Basics
                        </Typography>
                      </Typography>
                    </AccordionSummary>
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            PHP Syntax, Variables, Data Types, Constants,
                            Comments
                          </li>
                          <li>Operators: Arithmetic, Comparison, Assignment</li>
                          <li>Advanced Operators: Logical, Bitwise, Ternary</li>
                          <li>
                            Hands-on Practice: Basic PHP programs covering
                  ...
                  <Accordion className="accordion-box">
                    ...
                    >
                      <Typography>
                        ...
                        <Typography component="span" className="text-drop mt-1">
                          Control Structures and Introduction to Laravel
                        </Typography>
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          ...
                          <li>
                            Introduction to Laravel Framework: Installation,
                            Setup, Directory Structure
                          </li>
                          <li>Understanding MVC Pattern in Laravel</li>
                          <li>
                            Hands-on Practice: Write PHP programs and explore
                            Laravel basics
                          </li>
                        </ul>
                      </Typography>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Laravel Routing: Basic Routes, Passing Data to
                            Routes
                          </li>
                          <li>
                            Controllers: Creating Controllers, Routing to
                            Controllers, Passing Data to Views
                          </li>
                          <li>
                            Middleware: Understanding Middleware, Creating
                            Custom Middleware
                          </li>
                          <li>
                            Hands-on Practice: Build an app demonstrating
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Blade Templating Engine: Template Inheritance, Using
                            Components
                          </li>
                          <li>
                            Working with Forms: Creating Forms, Handling
                            Submissions, CSRF Protection
                          </li>
                          <li>
                            Validations: Laravel Validation Rules, Custom
                            Validation Messages
                          </li>
                          <li>
                            Hands-on Practice: Build a form-based app with
                            validation
                          </li>
                        </ul>
                      </Typography>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Database Configuration: Connecting to MySQL, Laravel
                            Configurations
                          </li>
                          <li>
                            Migrations: Creating, Modifying Tables, Running
                            Migrations
                          </li>
                          <li>Eloquent ORM: CRUD Operations, Query Builder</li>
                          <li>
                            Relationships in Eloquent: One-to-One, One-to-Many,
                            Many-to-Many
                          </li>
                          <li>
                            Hands-on Practice: Build a database-driven
                            application
                          </li>
                        </ul>
                      </Typography>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Authentication: Setting up and Customizing
                            Authentication
                          </li>
                          <li>
                            Authorization: Defining Roles and Permissions,
                            Middleware for Authorization
                          </li>
                          <li>
                            File Upload and Storage: Managing File Uploads and
                            Storage
                          </li>
                          <li>
                            Notifications: Sending Email Notifications, Using
                            Laravel Notifications
                          </li>
                          <li>
                            Hands-on Practice: Create an app demonstrating
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            RESTful APIs in Laravel: Creating API Routes,
                            Returning JSON
                          </li>
                          <li>
                            Consuming APIs: Fetching Data from External APIs
                          </li>
                          <li>
                            Testing APIs: Using Postman for Testing and Error
                            Handling
                          </li>
                          <li>
                            Advanced Features: Events, Listeners, Task
                            Scheduling
                          </li>
                          <li>
                            Hands-on Practice: Develop and test a RESTful API
                          </li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Setting Up the Final Project: Planning and
                            Structuring the Application
                          </li>
                          <li>
                            Backend: Implementing Models, Migrations, and
                            Controllers
                          </li>
                          <li>
                            Frontend: Using Blade Templates, Adding Forms,
                            Validations
                          </li>
                          <li>
                            Integrating APIs: Building APIs, Connecting Frontend
                            with Backend
                          </li>
                          <li>
                            Final Touches: Authentication, Authorization,
          ...
          <div className="d-flex flex-wrap-reverse justify-content-around mt-2 mt-md-5">
            <div className="industry-certificate">
              ...
              <div className="courses-trainig-details mt-2 mt-md-5">
                At Aryu Academy, our Laravel certification is trusted by leading
              ...
              <div className="benefits-courses mt-0 mt-md-5 pt-2">
                Benefits of Laravel Certification
              </div>
              <div className="courses-trainig-details mt-0 mt-md-5">
                <ul>
                  <li>
                    Prove your expertise by mastering Laravel and showcasing
                    your skills.
                  </li>
                  <li>
                  ...
                  <li>
                    Gain credibility as a go-to Laravel expert who drives
                    results.
                  </li>
                </ul>
              </div>
            ...
            <div>
              <img src={Certification} alt="Get an Industry-Recognized Certification in Laravel from ARYU Academy – 6-Month Course Completion" className="student-certificate" />
            </div>
          </div>
        </section>
          ...
          <div className="d-flex flex-wrap justify-content-around   pt-5">
            ...
            <div className="industry-certificate p-3 p-md-0 ">
              ...
              <div className="courses-trainig-benefits-para mt-5">
                Aryu Academy’s Laravel Training in Chennai. Led by
              ...
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingOne">
                    ...
                    >
                      What will I learn in this Laravel Training?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      <ul>
                        <li>
                          Laravel basics: Blade templates, routing, and
                          controllers
                        </li>
                        <li>Database migrations and Eloquent ORM</li>
                        <li>Building RESTful APIs</li>
                        <li>Authentication and authorization</li>
                        <li>Middleware, queues, and event handling</li>
                        <li>
                          Deployment and optimization of Laravel applications
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingTwo">
                    ...
                    >
                      Is Laravel good for creating APIs?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, Laravel is widely used to create secure, efficient,
                      and scalable RESTful APIs, making it ideal for modern web
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingThree">
                    ...
                    >
                      What career opportunities can Laravel training provide?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      After completing this course, you can pursue roles such
                      as:
                      <ul>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfour">
                    ...
                    >
                      Is Laravel secure for web development?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, Laravel includes built-in security features like CSRF
                      protection, password hashing, and SQL injection
                      prevention.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfive">
                    ...
                    >
                      How can I enroll in the Laravel Training course?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      You can sign up through our website or contact our support
                      team for enrollment assistance.
                    </div>
                  </div>
                </div>
                {/* <div class="accordion-item">
