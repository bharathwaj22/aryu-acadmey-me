...
import Coursesimage from "../assests/images/courses-banner-Img/Social-Media-Marketing-course-in-Chennai.png";
...
import ogimg from "../assests/images/metaogImg/smm.webp";

//tools
import Metamanagement from "../assests/images/tools/meta.svg";
import SocialBlade from "../assests/images/tools/SocialBlade.svg";
import Canva from "../assests/images/tools/canva.svg";
import Linktree from "../assests/images/tools/Linktree.svg";
import Hootsuite from "../assests/images/tools/Hootsuite.svg";
import MetricCool from "../assests/images/tools/MetricCool.svg";
import { useNavigate } from "react-router-dom";
function Smm() {
  useEffect(() => {
    // Set page title
    document.title = "Social Media Marketing course in chennai";
    ...
    setMetaTag(
      "description",
      "Social Media Marketing Courses in Chennai at Aryu Academy. Learn Facebook, Instagram, LinkedIn, WhatsApp marketing, create content, run ads, and track results."
    );
    setMetaTag(
      "keywords",
      "Social Media Marketing course in chennai, Social Media Marketing Training in chennai"
    );

    // Set Open Graph meta tags
    setMetaTag("og:title", "Social Media Marketing course in chennai", true);
    setMetaTag(
      "og:description",
      "Social Media Marketing Courses in Chennai at Aryu Academy. Learn Facebook, Instagram, LinkedIn, WhatsApp marketing, create content, run ads, and track results.",
      true
          ...
          <div className="courses-container ">
            <div className="courses-title mt-3">
              ...
              <div className="courses-description pt-3">
                Get a Social Media Marketing Course in Chennai at Aryu academy
            ...
            <Coursesform type={"soical_media_marketing"}></Coursesform>
          </div>
            ...
            <div className="d-flex justify-content-between flex-wrap-reverse flex-xl-nowrap ">
              <div className="about-training">
                ...
                <div className="courses-trainig-details mt-4">
                  Our Social Media Marketing course equips you with essential
                  skills to succeed on platforms like Facebook, Instagram,
                  LinkedIn, Twitter, and WhatsApp. You’ll learn to set SMART
                  goals, identify target audiences, and measure KPIs. The course
                  covers content creation across text, images, videos, and live
                  streams, ensuring effective engagement.
                </div>
                <div className="courses-trainig-details mt-4">
                  You'll also master platform-specific marketing techniques and
                  WhatsApp marketing strategies, learning how to use tools like
                  Canva for professional social media designs. Gain insights
                  into Facebook Ads Manager for running ads, retargeting, and
                  measuring campaign performance.
                </div>
                <div className="courses-trainig-details mt-4">
                  The course also teaches the use of essential tools for
                  scheduling, content management, and competitor analysis.
                  You’ll learn to generate and analyze monthly reports to track
                  engagement, reach, CTR, and ROI. By the end, you’ll have the
                  skills to boost brand visibility, engage audiences, and
              ...
              <div className="about-training-image pt-0 pt-md-5 ">
                <img
                  ...
                  src={Coursesimage}
                  alt="Social Media Marketing course at Aryu Academy in Chennai, teaching strategies to enhance online presence and engagement."
                />
              </div>
            </div>
          </div>
          ...
          <div className=" ">
            <div className="tool-used">
              ...
              <div className="d-flex  flex-wrap  ">
                <img
                  src={Metamanagement}
                  alt="Meta Management tools in Aryu Academy’s SMM course for handling Facebook and Instagram ads, pages, and insights."
                  className="tool-used-image"
                />
                <img src={SocialBlade} alt="Social Blade tools in Aryu Academy’s SMM course for tracking social media growth, analytics, and influencer insights." className="tool-used-image" />
                <img src={Canva} alt="js" className="tool-used-image" />
                <img src={Linktree} alt="Linktree tools in Aryu Academy’s SMM course for managing and sharing multiple social media links in one place." className="tool-used-image" />
                <img
                  src={Hootsuite}
                  alt="Hootsuite tools in Aryu Academy’s SMM course for scheduling posts, managing accounts, and tracking analytics."
                  className="tool-used-image"
                />
                <img
                  src={MetricCool}
                  alt="Metricool tools in Aryu Academy’s SMM course for planning, analyzing, and optimizing social media performance."
                  className="tool-used-image"
                />
              </div>
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          ...
                          <li>
                            Key Concepts: Engagement, Reach, Impressions, CTR,
                            ROI
                          </li>
                          <li>
                            Overview of Platforms: Facebook, Instagram,
                            LinkedIn, Twitter, Pinterest, WhatsApp
                          </li>
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          ...
                          <li>Identifying Target Audience and Personas</li>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Types of Content: Text, Image, Video, Stories, Live
                            StreamsContent Research and Optimization
                          </li>
                          <li>
                            Tools for Content Creation: Copy.ai, ChatGPT,
                            Predis.ai
                          </li>
                          <li>Writing Captivating Captions</li>
                          <li>Importance of Hashtags and Trends</li>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Introduction to Canva: Features and Tools</li>
                          <li>Creating Professional Social Media Designs</li>
                          <li>Exporting and Optimizing Designs</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Setting Up WhatsApp Business</li>
                          <li>Automated Messages and Labels</li>
                          <li>Broadcasts and Groups</li>
                          <li>WhatsApp Marketing Strategies</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Facebook Ads Manager Basics</li>
                  ...
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>
                            Content Creation Tools: Copy.ai, ChatGPT, Predis.ai
                          </li>
                          <li>
                            Scheduling and Management: Hootsuite, Publer.io
                          </li>
                          <li>Messaging and Engagement: ManyChat</li>
                          <li>Current Trends: Exploding Topics</li>
                          <li>
                            Design and Editing: Canva, Online Video Cutter
                          </li>
                          <li>Link Optimization: Linktree</li>
                          <li>Competitor Analysis: Social Blade</li>
                        </ul>
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                ...
                <div className="javascript pt-3">
                  <Accordion className="accordion-box">
                    ...
                    <AccordionDetails>
                      <Typography className="text-drop-details">
                        <ul>
                          <li>Creating and Submitting Monthly Reports</li>
                          <li>
                            Analyzing Engagement, Reach, Impressions, CTR, ROI
                          </li>
          ...
          <div className="d-flex flex-wrap-reverse justify-content-around mt-2 mt-md-5">
            <div className="industry-certificate">
              ...
              <div className="courses-trainig-details mt-2 mt-md-5">
                At Aryu Academy, our SMM certification is trusted by leading
              ...
              <div className="benefits-courses mt-0 mt-md-5 pt-2">
                Benefits of SMM Certification
              </div>
              <div className="courses-trainig-details mt-0 mt-md-5">
                <ul>
                  <li>
                    Prove your expertise by mastering SMM and showcasing your
                    skills.
                  </li>
                  <li>
                  ...
                  <li>
                    Gain credibility as a go-to SMM expert who drives results.
                  </li>
                </ul>
              </div>
            </div>
            <div>
              <img src={Certification} alt="Get an Industry-Recognized Certification in Social Media Marketing from ARYU Academy – 6-Month Course Completion." className="student-certificate" />
            </div>
          </div>
        </section>
          ...
          <div className="d-flex flex-wrap justify-content-around   pt-5">
            ...
            <div className="industry-certificate p-3 p-md-0 ">
              ...
              <div className="courses-trainig-benefits-para mt-5">
                Aryu Academy’s SMM Training in Chennai. Led by
              ...
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingOne">
                    ...
                    >
                      What Will I Learn in an SMM Course?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      In an SMM course, you’ll learn how to plan and execute
                      social media marketing campaigns on platforms like
                      Facebook, Instagram, LinkedIn, and Twitter. You’ll dive
                      into creating engaging content, understanding audience
                      targeting, running ads, growing a following, and measuring
                      campaign success.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      Social media marketing helps businesses build their brand,
                      connect with their target audience, and boost sales. With
                      billions of active users on platforms like Instagram and
                      Facebook, social media is one of the most powerful ways to
                      reach and engage potential customers, grow online
                      communities, and drive traffic to your website.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingThree">
                    ...
                    >
                      Can I Learn Social Media Marketing Without Any Experience?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Absolutely! SMM courses are designed for beginners, so you
                      don’t need prior experience to start. Whether you’re
                      looking to manage your business's social media or enter a
                      career in digital marketing, you can learn everything from
                      scratch. Courses typically cover everything from setting
                      up accounts to advanced strategies for maximizing reach.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfour">
                    ...
                    >
                      What Tools and Platforms Will I Learn to Use in an SMM
                      Course?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      You’ll gain proficiency in using social media platforms
                      like Facebook, Instagram, LinkedIn, Twitter, and YouTube.
                      You’ll also learn to use tools like Facebook Ads Manager,
                      Hootsuite, Buffer, Canva for designing posts, and Google
                      Analytics to track campaign performance and improve
                      strategies.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="flush-headingfive">
                    ...
                    >
                      How Do Social Media Ads Work, and Will I Learn to Create
                      Them?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div class="accordion-body">
                      Yes, you will learn how to create and run paid social
                      media ads on platforms like Facebook, Instagram, and
                      LinkedIn. The course will teach you targeting strategies,
                      how to set a budget, and how to analyze ad performance to
                      ensure your campaigns generate results.
                    </div>
                  </div>
                </div>
                {/* <div class="accordion-item">
